...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/open-chat-trobot-us#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/open-chat-trobot-us
```

A live public deployment of this template is available at [https://open-chat-trobot-us.templates.workers.dev](https://open-chat-trobot-us.templates.workers.dev)
